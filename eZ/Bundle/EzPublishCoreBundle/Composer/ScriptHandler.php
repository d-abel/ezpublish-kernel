...
class ScriptHandler extends DistributionBundleScriptHandler
{
    ...
    public static function dumpAssetsHelpText(Event $event)
    {
        ...
        $event->getIO()->write('    php bin/console assetic:dump --env=prod web');
        $event->getIO()->write('');
    }
...
<comment>    $  php bin/console ezplatform:install <type></comment>
<comment>    $  php bin/console assetic:dump</comment>
